...
int main() {
    ...
    // ofstream output_file("/home/murali/Documents/rass/data/sim_data/dived_data/cpp_data/alglib_CS_" + to_string(file_no) + "/backscatter_coordinates_" + to_string(file_no) + "_G250-r2.csv");
