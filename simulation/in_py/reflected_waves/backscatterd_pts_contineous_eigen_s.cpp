...
// Tuning Parameters
double rho = 5;  // Smoothing parameter
...
int main() {
    ...
    ofstream output_file("backscatter_coordinates_i_0_s_G250-r5.csv");
    output_file << "x_val,y_val,z_val,x_land,y_land,phi,theta\n";
...
void log_message(const string &message) {
    ofstream log_file("backscattering_progress_i_0_s_G200-r0.5.log", ios_base::app);
