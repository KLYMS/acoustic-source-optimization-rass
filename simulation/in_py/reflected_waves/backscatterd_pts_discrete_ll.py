...
# Set up logging
logging.basicConfig(filename='backscattering_progress.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main():
    ...
    logging.info(f"Finished writing results to CSV")
