# updated version of the pde_cor_edg_cpu.py which has logging functionality added in here
...
# Setup logging
logging.basicConfig(filename='ray_tracing_progress.log', level=logging.INFO,
...
if not Ideal_Conditions:
    logging.info('Reading the Radiosonde data')
    ...
    if With_spline:
        logging.info("Creating Splines from the data")
...
if With_temperature and With_wind:
    w_filename = "wTemp_wWind_0_cpu_log_low-res.csv"
